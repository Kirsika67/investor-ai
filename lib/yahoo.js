...
export const TREND_TYPES = [
  ...
  { id: 'growth', label: 'Growth Tech', title: 'Growth technology', screener: 'growth_technology_stocks', kind: 'growth' },
  { id: 'value', label: 'Undervalued Growth', title: 'Undervalued growth', screener: 'undervalued_growth_stocks', kind: 'value' },
  { id: 'smallcap', label: 'Small Cap Gainers', title: 'Small cap gainers', screener: 'small_cap_gainers', kind: 'smallcap' },
  { id: 'shorted', label: 'Most Shorted', title: 'Most shorted stocks', screener: 'most_shorted_stocks', kind: 'shorted' },
