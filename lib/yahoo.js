...
export async function getFundamentals(symbol) {
  ...
  return cached(`fund:${upper}`, 10 * 60 * 1000, async () => {
    const url = `https://query2.finance.yahoo.com/v10/finance/quoteSummary/${encodeURIComponent(upper)}?modules=summaryDetail,defaultKeyStatistics,price`;
